...
function Sidebar() {
  ...
  return (
    <div className="h-100% w-160px fixed z-1 left-0 p-5 bg-gradient-to-t from-sky-400 to-sky-100 rounded-b-xl shadow-xl">
      <button className="active:scale-75 transition duration-50 text-2xl font-bold text-white py-2 px-3 bg-sky-500 hover:bg-sky-800 text-3xl rounded-md shadow-xl my-2" onClick={() => setShowButton(!showButton)}>☰ Menu</button>
      {showButton &&
        <div className="mt-5">
